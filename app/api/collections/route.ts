import { CreateCollectionDocument, GetCollectionDocument, GetListCollectionDocument } from "@/generated/graphql"
...
export const POST = async (req: NextRequest) => {
  try {
    ...
    const newCollection = createCollection(title, description, image)
...
export const GET = async () => {
  try {
    ...
    return NextResponse.json(data.getListCollection.listCollection, { status: 200 })
